...
class ReconstructionServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.HealthCheck = channel.unary_unary(
                '/reconstruction.ReconstructionService/HealthCheck',
        ...
        self.ProcessFrame = channel.unary_unary(
                '/reconstruction.ReconstructionService/ProcessFrame',
...
class ReconstructionServiceServicer:
    """Missing associated documentation comment in .proto file."""
...
def add_ReconstructionServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'reconstruction.ReconstructionService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('reconstruction.ReconstructionService', rpc_method_handlers)
